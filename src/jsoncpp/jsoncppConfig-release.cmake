...
set_target_properties(jsoncpp_lib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_DIR}/jsoncpp-build/lib/libjsoncpp.1.9.4.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libjsoncpp.24.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS jsoncpp_lib )
list(APPEND _IMPORT_CHECK_FILES_FOR_jsoncpp_lib "${_DIR}/jsoncpp-build/lib/libjsoncpp.24.dylib" )
...
set_target_properties(jsoncpp_lib_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_DIR}/jsoncpp-build/lib/libjsoncpp_lib_static.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS jsoncpp_lib_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_jsoncpp_lib_static "${_DIR}/jsoncpp-build/lib/libjsoncpp_lib_static.a" )
